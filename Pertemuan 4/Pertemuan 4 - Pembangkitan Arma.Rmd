...
#1-7 merupakan ordo AR sedangkan 0-13 merupakan ordo MA
```

Berdasarkan pola segitiga nol pada plot EACF, terlihat bahwa segitiga nol berada pada ordo AR(0) dan ordo MA(1). Karena jika kita lihat pada titik (0,1) (AR,MA) meruoakan titik awal muncul 0 pada segitiga nol.

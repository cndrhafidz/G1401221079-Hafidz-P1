...
*Catatan* : Untuk mengetahui stasioner dalam ragam atau tidak, yaitu dengan cara melihat angka 1 masuk atau tidak kedalam plot
...
Plot deret waktu di atas menunjukkan bahwa data stasioner dalam rataan (karena secara eksplorasi lebar pitanya sama dan terlihat bergerak dirataan 18), ditandai dengan data yang menyebar di sekitar nilai tengahnya (18) dan stasioner dalam ragam, ditandai dengan lebar pita yang cenderung sama.
...
Berdasarkan plot ACF, terlihat bahwa plot ACF pada data tersebut cenderung *tails off* dan membentuk gelombang sinus. Karena *tails off*, maka stasioner dalam rataan (apabila *cut off* tetap saja akan stasioner dalam rataan, kecuali *tails off slowly*)
...
Berdasarkan plot ACF, terlihat bahwa plot ACF pada data tersebut cenderung *tails off* dan membentuk gelombang sinus, maka stasioner dalam rataan (mau dia *tails off* atau *cutt off* dia akan stasioner dalam rataan, kecuali *tails off slowly*)
...
acf(postrend)
```
Tidak stasioner dalam rataan, ditandai dengan plot ACF yang *tails off slowly*
...
adf.test(postrend)
```
Tidak stasioner dalam rataan, karena p-value lebih besar dari 0.05.
...
*CATATAN* : apabila ditemukan kasus dimana tidak stasioner dalam rataan maupun ragam. Maka, kita harus menangani yang dalam ragam terlebih dahulu. Karena biasanya dengan menangani ragam dahulu maka rataan juga akan teratasi. Akan tetapi, jika kita menangani rataan terlebih dahulu, maka kita akan melakukan differencing dimana akan ada nilai yang negatif. Nilai negatif ini tidak bisa untuk melakukan transformasi Box-Cox, sehingga kita harus menangani ragam terlebih dahulu.
### Partisi Data
...
acf(postrend1)
```
Karena *tails off slowly* maka tidak stasioner dalam rataan 
...
adf.test(postrend1)
```
Karena p-value lebih kecil dari 0.05 maka stasioner dalam rataan. Namun, saat uji ACF menunjukkan *tails off slowly* maka tidak stasioner dalam rataan. Dalam kasus ini kita akan memilih hasil uji eksplorasi, yaitu uji ACF. Krena dengan eskplorasi kita bisa mengetahui ordo untuk ARIMA
